...
export class WebGL2Fallback {
    ...
    private setupDefaultState(): void {
        ...
        // Set clear color to sky blue to indicate rendering
    ...
    private async createFallbackShaders(): Promise<void> {
        ...
        const basicProgram = this.createShaderProgram(
            'basic',
            basicVertexSource,
            basicFragmentSource
        );
    ...
    private createShaderProgram(
        ...
        if (!gl.getShaderParameter(vertexShader, gl.COMPILE_STATUS)) {
            console.error(
                `Vertex shader compilation error (${name}):`,
        ...
        if (!gl.getShaderParameter(fragmentShader, gl.COMPILE_STATUS)) {
            console.error(
                `Fragment shader compilation error (${name}):`,
